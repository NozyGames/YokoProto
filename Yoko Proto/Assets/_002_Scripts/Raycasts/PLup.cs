...
public class PLup : MonoBehaviour
{
    public LayerMask Kyoko;
    void Update()
    {
        //Je créé un Raycast nommé Hit qui part de la position du Yoko et va vers le haut sur une distance de 1 et qui ne touche que les Kyokos
